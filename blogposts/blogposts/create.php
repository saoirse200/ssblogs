...
<h1> <a  href="../index.html"> <img src="S&S Blogs Logo.jpg" alt="Home" width="150" height="150";></a></h1>
   ...
   <div class="container mt-5">
        <form method="POST">
            <input type="text" placeholder="Blog Title" class="form-control my-3 text-dark text-center" name="title">
            <textarea name="content" class="form-control my-3 text-dark" cols="30" rows="10"></textarea>
            <button class="btn btn-dark" name="new_post" style="background-color:#B9D8D2">Add Post</button>
        </form>
   </div>
